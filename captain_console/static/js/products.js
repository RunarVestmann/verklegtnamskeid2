    ...
    return `<div class="products-box">
                            <div class="container-fluid">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6 p-1">
                                        ${product.quantity == 0 ? '<div role="button" onclick="addToCart(${ product.id })" class="btn btn-success btn-block" style="font-size: 1.2rem">Setja í körfu</div>' : '<div class="btn btn-secondary btn-block disabled" aria-disabled="true" style="font-size: 1.2rem;cursor: default;">Væntanlegt</div>'}
                                    </div>
                                </div>
                            </div>
                        </div>`;
